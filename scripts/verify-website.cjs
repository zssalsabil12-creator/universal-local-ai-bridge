...
const releaseDownloadUrl = 'https://github.com/zssalsabil12-creator/universal-local-ai-bridge/releases/download/v3.10.8/ULAB-Setup-3.10.8-Windows-x64.exe';
...
console.log('RELEASE_DOWNLOAD=v3.10.8');
