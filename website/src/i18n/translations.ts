...
export const translations: Record<Language, Translation> = {
  ...
  ar: {
    ...
    'howItWorks.subtitle': 'ست خطوات بسيطة لربط الذكاء الاصطناعي بمشروعك',
    'howItWorks.step1.title': 'ثبّت تطبيق ULAB لسطح المكتب',
    'howItWorks.step1.desc': 'نزّل ULAB لنظام Windows وثبّته على جهازك',
    'howItWorks.step2.title': 'اختر مساحة العمل',
    'howItWorks.step2.desc': 'افتح ULAB وحدد مجلد المشروع الذي سيصبح مساحة العمل النشطة',
    'howItWorks.step3.title': 'افتح جلسة الذكاء الاصطناعي',
    'howItWorks.step3.desc': 'افتح ChatGPT أو Claude أو Gemini أو أي دردشة AI تستخدمها',
    'howItWorks.step4.title': 'فعّل الجسر',
    'howItWorks.step4.desc': 'شغّل تشخيص صفحة AI ثم اربط الجلسة بالجسر المحلي',
    'howItWorks.step5.title': 'أرسل السياق واستخدم الأدوات',
    'howItWorks.step5.desc': 'ينقل ULAB السياق المطلوب ويتيح عمليات الملفات والبحث والأدوات',
    'howItWorks.step6.title': 'راجع التغييرات ووافق عليها',
    'howItWorks.step6.desc': 'تبقى تغييرات الملفات والعمليات الحساسة خلف موافقتك الصريحة',
    ...
    'architecture.local.extension': 'تطبيق ULAB لسطح المكتب',
    ...
    'roadmap.phase1': 'تطبيق سطح المكتب + الوكيل المحلي',
    'roadmap.phase1.desc': 'تطبيق سطح مكتب يتضمن الوكيل المحلي واتصالًا آمنًا بمساحة العمل',
    'roadmap.phase2': 'جسر AI موحّد',
    'roadmap.phase2.desc': 'اتصال مباشر بجلسات الذكاء الاصطناعي على الويب مع تشخيص تلقائي',
    'roadmap.phase3': 'الأمان ومراحل الموافقة',
    'roadmap.phase3.desc': 'حماية المسارات والملفات الحساسة وعزل الطرفية وموافقات التعديلات',
    'roadmap.phase4': 'دعم مزوّدي AI المتعددين',
    'roadmap.phase4.desc': 'ChatGPT وClaude وGemini وDeepSeek وغيرها مع دعم الروابط المخصصة',
    'roadmap.phase5': 'حلقة AI الحية',
    'roadmap.phase5.desc': 'إرسال السياق واستقبال الردود ومتابعة دورة الأدوات والتعديلات',
    'roadmap.phase6': 'اختبار الإصدار وصقله',
    'roadmap.phase6.desc': 'اختبارات شاملة وتحسينات الاستقرار وتجربة المستخدم والتوزيع',
    'roadmap.current': 'مكتمل',
    
    'faq.title': 'أسئلة شائعة',
    'faq.subtitle': 'إجابات على أكثر الأسئلة شيوعًا',
    'faq.q1': 'هل يحتاج ULAB إلى خادم سحابي؟',
    'faq.a1': 'لا. ULAB يعمل محليًا على جهازك، والوكيل المحلي يتصل عبر localhost. لا يحتاج تشغيل مساحة العمل المحلية إلى خادم سحابي.',
    ...
    'faq.q3': 'ما جلسات الذكاء الاصطناعي المدعومة؟',
    'faq.a3': 'يدعم ULAB جلسات AI عبر الويب مثل ChatGPT وClaude وGemini وDeepSeek وغيرها، مع إمكانية استخدام روابط AI مخصصة.',
    ...
    'faq.q5': 'هل ULAB مجاني؟',
    'faq.a5': 'نعم. ULAB مفتوح المصدر تحت رخصة MIT، وتطبيق سطح المكتب والوكيل المحلي مجانيان.',
    ...
    'cta.subtitle': 'نزّل التطبيق، حدّد مساحة العمل، وافتح جلسة AI — ULAB يتولى الربط المحلي.',
    'cta.button': 'إطلاق الأداة',
    'cta.download': 'تحميل ULAB لنظام Windows',
    
    'footer.rights': '© 2026 Universal Local AI Bridge. مفتوح المصدر تحت رخصة MIT.',
  ...
  en: {
    ...
    'howItWorks.subtitle': 'Six simple steps to connect AI to your project',
    'howItWorks.step1.title': 'Install the ULAB Desktop App',
    'howItWorks.step1.desc': 'Download ULAB for Windows and install it on your device',
    'howItWorks.step2.title': 'Select Your Workspace',
    'howItWorks.step2.desc': 'Open ULAB and choose the project folder that becomes the active workspace',
    'howItWorks.step3.title': 'Open Your AI Session',
    'howItWorks.step3.desc': 'Open ChatGPT, Claude, Gemini, or any online AI chat you use',
    'howItWorks.step4.title': 'Activate the Bridge',
    'howItWorks.step4.desc': 'Run AI-page diagnostics, then connect the session to the local bridge',
    'howItWorks.step5.title': 'Send Context and Use Tools',
    'howItWorks.step5.desc': 'ULAB moves the needed context and enables file, search, and tool operations',
    'howItWorks.step6.title': 'Review and Approve Changes',
    'howItWorks.step6.desc': 'File changes and sensitive operations stay behind your explicit approval',
    ...
    'architecture.local.extension': 'ULAB Desktop App',
    ...
    'roadmap.phase1': 'Desktop App + Local Agent',
    'roadmap.phase1.desc': 'Desktop application with the local agent and secure workspace connection',
    'roadmap.phase2': 'Universal AI Bridge',
    'roadmap.phase2.desc': 'Direct connection to web-based AI sessions with automatic diagnostics',
    'roadmap.phase3': 'Security & Approval Gates',
    'roadmap.phase3.desc': 'Path protection, sensitive-file blocking, terminal isolation, and approval-first changes',
    'roadmap.phase4': 'Multi-Provider AI Support',
    'roadmap.phase4.desc': 'ChatGPT, Claude, Gemini, DeepSeek, and more with custom AI URLs',
    'roadmap.phase5': 'Live AI Bridge Loop',
    'roadmap.phase5.desc': 'Context handoff, response capture, tool execution, and change tracking',
    'roadmap.phase6': 'Release Testing & Polish',
    'roadmap.phase6.desc': 'Comprehensive verification, stability improvements, UX polish, and distribution',
    'roadmap.current': 'Complete',
    
    'faq.title': 'Frequently Asked Questions',
    'faq.subtitle': 'Answers to the most common questions',
    'faq.q1': 'Does ULAB need a cloud server?',
    'faq.a1': 'No. ULAB runs locally on your device, and the local agent connects through localhost. The local workspace does not require a cloud server.',
    ...
    'faq.q3': 'Which AI sessions are supported?',
    'faq.a3': 'ULAB supports web-based AI sessions such as ChatGPT, Claude, Gemini, DeepSeek, and more, plus custom AI URLs.',
    ...
    'faq.q5': 'Is ULAB free?',
    'faq.a5': 'Yes. ULAB is open source under the MIT license, and the desktop app and local agent are free.',
    ...
    'cta.subtitle': 'Install the app, select your workspace, and open an AI session — ULAB handles the local bridge.',
    'cta.button': 'Launch Tool',
    'cta.download': 'Download ULAB for Windows',
    
    'footer.rights': '© 2026 Universal Local AI Bridge. Open source under the MIT license.',
  ...
  es: {
    ...
    'howItWorks.subtitle': 'Seis pasos sencillos para conectar la IA con tu proyecto',
    'howItWorks.step1.title': 'Instala la aplicación de escritorio de ULAB',
    'howItWorks.step1.desc': 'Descarga ULAB para Windows e instálalo en tu dispositivo',
    'howItWorks.step2.title': 'Selecciona tu espacio de trabajo',
    'howItWorks.step2.desc': 'Abre ULAB y elige la carpeta del proyecto que será el espacio de trabajo activo',
    'howItWorks.step3.title': 'Abre tu sesión de IA',
    'howItWorks.step3.desc': 'Abre ChatGPT, Claude, Gemini o cualquier chat de IA web que utilices',
    'howItWorks.step4.title': 'Activa el puente',
    'howItWorks.step4.desc': 'Ejecuta el diagnóstico de la página de IA y conecta la sesión con el puente local',
    'howItWorks.step5.title': 'Envía contexto y usa las herramientas',
    'howItWorks.step5.desc': 'ULAB transfiere el contexto necesario y habilita operaciones de archivos, búsqueda y herramientas',
    'howItWorks.step6.title': 'Revisa y aprueba los cambios',
    'howItWorks.step6.desc': 'Los cambios de archivos y las operaciones sensibles requieren tu aprobación explícita',
    ...
    'architecture.local.extension': 'Aplicación de escritorio de ULAB',
    ...
    'roadmap.phase1': 'Aplicación de escritorio + agente local',
    'roadmap.phase1.desc': 'Aplicación de escritorio con agente local y conexión segura al espacio de trabajo',
    'roadmap.phase2': 'Puente universal de IA',
    'roadmap.phase2.desc': 'Conexión directa con sesiones de IA web y diagnóstico automático',
    'roadmap.phase3': 'Seguridad y aprobaciones',
    'roadmap.phase3.desc': 'Protección de rutas y archivos sensibles, aislamiento de terminal y cambios con aprobación',
    'roadmap.phase4': 'Compatibilidad con múltiples proveedores de IA',
    'roadmap.phase4.desc': 'ChatGPT, Claude, Gemini, DeepSeek y más, con URLs de IA personalizadas',
    'roadmap.phase5': 'Bucle de puente de IA en vivo',
    'roadmap.phase5.desc': 'Transferencia de contexto, captura de respuestas, herramientas y seguimiento de cambios',
    'roadmap.phase6': 'Pruebas y acabado de la versión',
    'roadmap.phase6.desc': 'Verificación completa, estabilidad, mejoras de UX y distribución',
    'roadmap.current': 'Completado',
    
    'faq.title': 'Preguntas Frecuentes',
    'faq.subtitle': 'Respuestas a las preguntas más comunes',
    'faq.q1': '¿ULAB necesita un servidor en la nube?',
    'faq.a1': 'No. ULAB se ejecuta localmente en tu dispositivo y el agente local se conecta mediante localhost. El espacio de trabajo local no requiere un servidor en la nube.',
    ...
    'faq.q3': '¿Qué sesiones de IA son compatibles?',
    'faq.a3': 'ULAB admite sesiones de IA web como ChatGPT, Claude, Gemini, DeepSeek y más, además de URL de IA personalizadas.',
    ...
    'faq.q5': '¿ULAB es gratuito?',
    'faq.a5': 'Sí. ULAB es de código abierto bajo la licencia MIT, y la aplicación de escritorio y el agente local son gratuitos.',
    ...
    'cta.subtitle': 'Instala la aplicación, selecciona tu espacio de trabajo y abre una sesión de IA — ULAB gestiona el puente local.',
    'cta.button': 'Iniciar Herramienta',
    'cta.download': 'Descargar ULAB para Windows',
    
    'footer.rights': '© 2026 Universal Local AI Bridge. Código abierto bajo la licencia MIT.',
  ...
  fr: {
    ...
    'howItWorks.subtitle': 'Six étapes simples pour connecter l’IA à votre projet',
    'howItWorks.step1.title': 'Installer l’application de bureau ULAB',
    'howItWorks.step1.desc': 'Téléchargez ULAB pour Windows et installez-le sur votre appareil',
    'howItWorks.step2.title': 'Sélectionner votre espace de travail',
    'howItWorks.step2.desc': 'Ouvrez ULAB et choisissez le dossier du projet qui devient l’espace de travail actif',
    'howItWorks.step3.title': 'Ouvrir votre session IA',
    'howItWorks.step3.desc': 'Ouvrez ChatGPT, Claude, Gemini ou tout autre chat IA en ligne que vous utilisez',
    'howItWorks.step4.title': 'Activer le pont',
    'howItWorks.step4.desc': 'Lancez le diagnostic de la page IA, puis connectez la session au pont local',
    'howItWorks.step5.title': 'Envoyer le contexte et utiliser les outils',
    'howItWorks.step5.desc': 'ULAB transfère le contexte nécessaire et permet les opérations sur les fichiers, la recherche et les outils',
    'howItWorks.step6.title': 'Vérifier et approuver les modifications',
    'howItWorks.step6.desc': 'Les modifications de fichiers et les opérations sensibles restent soumises à votre approbation explicite',
    ...
    'architecture.local.extension': 'Application de bureau ULAB',
    ...
    'roadmap.phase1': 'Application de bureau + agent local',
    'roadmap.phase1.desc': 'Application de bureau avec agent local et connexion sécurisée à l’espace de travail',
    'roadmap.phase2': 'Pont IA universel',
    'roadmap.phase2.desc': 'Connexion directe aux sessions IA sur le web avec diagnostic automatique',
    'roadmap.phase3': 'Sécurité et étapes d’approbation',
    'roadmap.phase3.desc': 'Protection des chemins et fichiers sensibles, isolation du terminal et modifications soumises à approbation',
    'roadmap.phase4': 'Prise en charge de plusieurs fournisseurs IA',
    'roadmap.phase4.desc': 'ChatGPT, Claude, Gemini, DeepSeek et plus, avec URLs IA personnalisées',
    'roadmap.phase5': 'Boucle de pont IA en direct',
    'roadmap.phase5.desc': 'Transfert de contexte, capture des réponses, outils et suivi des modifications',
    'roadmap.phase6': 'Tests et finition de la version',
    'roadmap.phase6.desc': 'Vérification complète, stabilité, amélioration de l’expérience et distribution',
    'roadmap.current': 'Terminé',
    
    'faq.title': 'Questions fréquemment posées',
    'faq.subtitle': 'Réponses aux questions les plus courantes',
    'faq.q1': 'ULAB a-t-il besoin d’un serveur cloud ?',
    'faq.a1': 'Non. ULAB s’exécute localement sur votre appareil et l’agent local se connecte via localhost. L’espace de travail local ne nécessite pas de serveur cloud.',
    ...
    'faq.q3': 'Quelles sessions IA sont prises en charge ?',
    'faq.a3': 'ULAB prend en charge les sessions IA sur le web comme ChatGPT, Claude, Gemini, DeepSeek et plus, ainsi que les URL IA personnalisées.',
    ...
    'faq.q5': 'ULAB est-il gratuit ?',
    'faq.a5': 'Oui. ULAB est open source sous licence MIT, et l’application de bureau ainsi que l’agent local sont gratuits.',
    ...
    'cta.subtitle': 'Installez l’application, sélectionnez votre espace de travail et ouvrez une session IA — ULAB gère le pont local.',
    'cta.button': 'Lancer l\'outil',
    'cta.download': 'Télécharger ULAB pour Windows',
    
    'footer.rights': '© 2026 Universal Local AI Bridge. Open source sous licence MIT.',
  ...
  ko: {
    ...
    'howItWorks.subtitle': 'AI를 프로젝트에 연결하는 6가지 간단한 단계',
    'howItWorks.step1.title': 'ULAB 데스크톱 앱 설치',
    'howItWorks.step1.desc': 'Windows용 ULAB을 다운로드하여 장치에 설치합니다',
    'howItWorks.step2.title': '작업 공간 선택',
    'howItWorks.step2.desc': 'ULAB을 열고 활성 작업 공간으로 사용할 프로젝트 폴더를 선택합니다',
    'howItWorks.step3.title': 'AI 세션 열기',
    'howItWorks.step3.desc': 'ChatGPT, Claude, Gemini 또는 사용하는 웹 AI 채팅을 엽니다',
    'howItWorks.step4.title': '브릿지 활성화',
    'howItWorks.step4.desc': 'AI 페이지 진단을 실행한 다음 세션을 로컬 브릿지에 연결합니다',
    'howItWorks.step5.title': '컨텍스트 전송 및 도구 사용',
    'howItWorks.step5.desc': 'ULAB이 필요한 컨텍스트를 전달하고 파일, 검색 및 도구 작업을 사용할 수 있게 합니다',
    'howItWorks.step6.title': '변경 사항 검토 및 승인',
    'howItWorks.step6.desc': '파일 변경과 민감한 작업에는 명시적인 승인이 필요합니다',
    ...
    'architecture.local.extension': 'ULAB 데스크톱 앱',
    ...
    'roadmap.phase1': '데스크톱 앱 + 로컬 에이전트',
    'roadmap.phase1.desc': '로컬 에이전트와 보안 작업 공간 연결을 제공하는 데스크톱 애플리케이션',
    'roadmap.phase2': '범용 AI 브릿지',
    'roadmap.phase2.desc': '자동 진단을 지원하는 웹 기반 AI 세션 직접 연결',
    'roadmap.phase3': '보안 및 승인 게이트',
    'roadmap.phase3.desc': '경로 보호, 민감한 파일 차단, 터미널 격리 및 승인 기반 변경',
    'roadmap.phase4': '다중 AI 제공업체 지원',
    'roadmap.phase4.desc': 'ChatGPT, Claude, Gemini, DeepSeek 등을 사용자 지정 AI URL과 함께 지원',
    'roadmap.phase5': '실시간 AI 브릿지 루프',
    'roadmap.phase5.desc': '컨텍스트 전달, 응답 수집, 도구 실행 및 변경 추적',
    'roadmap.phase6': '출시 테스트 및 완성',
    'roadmap.phase6.desc': '종합 검증, 안정성 개선, UX 다듬기 및 배포',
    'roadmap.current': '완료',
    
    'faq.title': '자주 묻는 질문',
    'faq.subtitle': '가장 일반적인 질문에 대한 답변',
    'faq.q1': 'ULAB에 클라우드 서버가 필요한가요?',
    'faq.a1': '아니요. ULAB은 장치에서 로컬로 실행되며 로컬 에이전트는 localhost를 통해 연결됩니다. 로컬 작업 공간에는 클라우드 서버가 필요하지 않습니다.',
    'faq.q2': '내 파일이 안전한가요?',
    'faq.a2': '네! 에이전트는 localhost(127.0.0.1) 전용이며 토큰으로 인증됩니다. PathGuard가 경로 변환과 민감한 파일을 차단합니다. 수정 사항에는 명시적 승인이 필요합니다.',
    'faq.q3': '어떤 AI 세션을 지원하나요?',
    'faq.a3': 'ULAB은 ChatGPT, Claude, Gemini, DeepSeek 등 웹 기반 AI 세션과 사용자 지정 AI URL을 지원합니다.',
    'faq.q4': '프로젝트를 어떤 AI와 함께 사용할 수 있나요?',
    'faq.a4': '네! ChatGPT, Claude, Gemini, DeepSeek, Qwen, Mistral, Grok 등을 지원합니다 — 모든 웹 기반 AI 채팅.',
    'faq.q5': 'ULAB은 무료인가요?',
    'faq.a5': '네. ULAB은 MIT 라이선스의 오픈 소스이며 데스크톱 앱과 로컬 에이전트는 무료입니다.',
    ...
    'cta.subtitle': '앱을 설치하고 작업 공간을 선택한 후 AI 세션을 열면 ULAB이 로컬 브릿지를 처리합니다.',
    'cta.button': '도구 실행',
    'cta.download': 'Windows용 ULAB 다운로드',
    
    'footer.rights': '© 2026 Universal Local AI Bridge. MIT 라이선스의 오픈 소스 프로젝트입니다.',
  ...
  zh: {
    ...
    'howItWorks.subtitle': '将 AI 连接到项目的六个简单步骤',
    'howItWorks.step1.title': '安装 ULAB 桌面应用',
    'howItWorks.step1.desc': '下载 Windows 版 ULAB 并安装到您的设备',
    'howItWorks.step2.title': '选择工作空间',
    'howItWorks.step2.desc': '打开 ULAB 并选择作为活动工作空间的项目文件夹',
    'howItWorks.step3.title': '打开 AI 会话',
    'howItWorks.step3.desc': '打开 ChatGPT、Claude、Gemini 或您使用的任何网页版 AI 聊天',
    'howItWorks.step4.title': '激活桥接',
    'howItWorks.step4.desc': '运行 AI 页面诊断，然后将会话连接到本地桥接器',
    'howItWorks.step5.title': '发送上下文并使用工具',
    'howItWorks.step5.desc': 'ULAB 传递所需上下文，并启用文件、搜索和工具操作',
    'howItWorks.step6.title': '审查并批准更改',
    'howItWorks.step6.desc': '文件更改和敏感操作必须经过您的明确批准',
    ...
    'architecture.local.extension': 'ULAB 桌面应用',
    ...
    'roadmap.phase1': '桌面应用 + 本地代理',
    'roadmap.phase1.desc': '包含本地代理并安全连接工作空间的桌面应用',
    'roadmap.phase2': '通用 AI 桥接',
    'roadmap.phase2.desc': '直接连接网页版 AI 会话并自动进行页面诊断',
    'roadmap.phase3': '安全与审批机制',
    'roadmap.phase3.desc': '路径保护、敏感文件拦截、终端隔离以及更改审批',
    'roadmap.phase4': '多 AI 提供商支持',
    'roadmap.phase4.desc': '支持 ChatGPT、Claude、Gemini、DeepSeek 等，并支持自定义 AI URL',
    'roadmap.phase5': '实时 AI 桥接循环',
    'roadmap.phase5.desc': '上下文传递、响应捕获、工具执行和更改跟踪',
    'roadmap.phase6': '发布测试与完善',
    'roadmap.phase6.desc': '全面验证、稳定性改进、用户体验优化和分发',
    'roadmap.current': '已完成',
    
    'faq.title': '常见问题',
    'faq.subtitle': '最常见问题的答案',
    'faq.q1': 'ULAB 需要云服务器吗？',
    'faq.a1': '不需要。ULAB 在您的设备上本地运行，本地代理通过 localhost 连接。运行本地工作空间不需要云服务器。',
    'faq.q2': '我的文件安全吗？',
    'faq.a2': '是的！代理仅限于localhost（127.0.0.1）并使用令牌认证。PathGuard阻止路径遍历和敏感文件。修改需要您的明确批准。',
    'faq.q3': '支持哪些 AI 会话？',
    'faq.a3': 'ULAB 支持 ChatGPT、Claude、Gemini、DeepSeek 等网页版 AI 会话，并支持自定义 AI URL。',
    'faq.q4': '项目可以与任何AI一起使用吗？',
    'faq.a4': '是的！支持ChatGPT、Claude、Gemini、DeepSeek、Qwen、Mistral、Grok等 — 任何基于网络的AI聊天。',
    'faq.q5': 'ULAB 免费吗？',
    'faq.a5': '是的。ULAB 是 MIT 许可下的开源项目，桌面应用和本地代理均免费。',
    'faq.q6': '它如何处理巨大的项目？',
    'faq.a6': 'ULAB不发送整个项目。AI通过工具调用请求特定文件 — 代理仅在本地执行请求的文件。',
    
    'cta.title': '准备好将AI连接到您的项目了吗？',
    'cta.subtitle': '安装应用、选择工作空间并打开 AI 会话 — ULAB 负责本地桥接。',
    'cta.button': '启动工具',
    'cta.download': '下载 Windows 版 ULAB',
    
    'footer.rights': '© 2026 Universal Local AI Bridge。基于 MIT 许可证的开源项目。',
    'footer.local': '默认本地',
    'footer.privacy': '设计隐私',
