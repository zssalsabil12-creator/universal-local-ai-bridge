          ...
          {selectedFile ? (
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className="ulab-empty-state text-center max-w-2xl px-8">
                <div className="ulab-orbit-logo mx-auto mb-6">
                  <div className="ulab-orbit ulab-orbit-one"></div>
                  <div className="ulab-orbit ulab-orbit-two"></div>
                  <BrandMark size={72} showWordmark={false} />
                </div>
                <div className="ulab-eyebrow mx-auto mb-3">UNIVERSAL LOCAL AI BRIDGE</div>
                <h2 className="text-3xl md:text-4xl font-black tracking-tight mb-3">Your AI. <span className="gradient-text">Your workspace.</span></h2>
