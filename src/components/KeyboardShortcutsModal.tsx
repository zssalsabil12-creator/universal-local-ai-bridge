  ...
  const shortcuts = [
    {
      category: 'عام',
      items: [
        { keys: ['Ctrl', 'O'], description: 'فتح مجلد مشروع' },
        { keys: ['Ctrl', 'F'], description: 'بحث في الملفات' },
        { keys: ['Ctrl', 'K'], description: 'بحث سريع' },
        { keys: ['Ctrl', ','], description: 'الإعدادات' },
        { keys: ['Ctrl', '?'], description: 'عرض الاختصارات' },
        { keys: ['Esc'], description: 'إغلاق النوافذ' },
      ],
    },
    {
      category: 'التنقل بين اللوحات',
      items: [
        { keys: ['Ctrl', '1'], description: 'لوحة AI' },
        { keys: ['Ctrl', '2'], description: 'لوحة Bridge' },
        { keys: ['Ctrl', '3'], description: 'لوحة Agent' },
        { keys: ['Ctrl', '4'], description: 'الذاكرة' },
        { keys: ['Ctrl', '5'], description: 'الصلاحيات' },
        { keys: ['Ctrl', '6'], description: 'المهام' },
        { keys: ['Ctrl', '7'], description: 'السياق' },
        { keys: ['Ctrl', '8'], description: 'Git' },
        { keys: ['Ctrl', '9'], description: 'Terminal' },
      ],
    },
    {
      category: 'الملفات',
      items: [
        { keys: ['Ctrl', 'S'], description: 'حفظ الملف' },
        { keys: ['Ctrl', 'C'], description: 'نسخ المحتوى' },
        { keys: ['Ctrl', 'Shift', 'C'], description: 'نسخ المسار' },
      ],
    },
    {
      category: 'AI Bridge',
      items: [
        { keys: ['Ctrl', 'Enter'], description: 'إرسال السؤال' },
        { keys: ['Ctrl', 'Shift', 'V'], description: 'لصق رد AI' },
        { keys: ['Ctrl', 'Shift', 'C'], description: 'نسخ السياق' },
      ],
    },
  ];
