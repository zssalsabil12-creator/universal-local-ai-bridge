  ...
  return (
    ...
    >
      <div className="flex items-center justify-between text-[10px] text-[#64748b] mb-2 px-1">
        <span className="flex items-center gap-1 font-medium tracking-wider uppercase">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-[#94a3b8]">
                متوافق تماماً مع سياسات AdSense لتطبيقات الويب (SaaS) لتحقيق أعلى عائد من وقت بقاء المطورين.
              </p>
            </div>
          </div>
