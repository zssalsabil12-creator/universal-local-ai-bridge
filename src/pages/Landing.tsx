...
function Navbar({ onLaunch }: { onLaunch: () => void }) {
  const { t } = useLanguage();
  const downloadUrl = '/downloads/ULAB-Setup.exe';
    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            <LanguageSwitcher />
            <a href={downloadUrl} download="ULAB-Setup.exe" className="hidden md:inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#111827]/80 border border-cyan-400/25 text-cyan-200 text-sm font-bold hover:border-cyan-300/50 hover:bg-cyan-400/10 transition-all">
        ...
        {mobileOpen && (
          ...
          >
            <div className="px-4 py-4 space-y-3">
              ...
              <a href={downloadUrl} download="ULAB-Setup.exe" onClick={() => setMobileOpen(false)} className="flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-xl border border-cyan-400/25 bg-cyan-400/10 text-cyan-200 text-sm font-bold">
                <Download className="w-4 h-4" />
                {t('nav.download')}
              </a>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
            <a href="/downloads/ULAB-Setup.exe" download="ULAB-Setup.exe" className="px-10 py-4 rounded-2xl bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 text-white font-bold text-lg hover:shadow-2xl hover:shadow-cyan-500/30 transition-all animate-pulse-glow">
...
function StatsSection() {
  ...
  const stats = [
    ...
    { value: 'âˆž', label: t('stats.projects'), icon: <Cpu className="w-8 h-8" />, gradient: 'from-cyan-400 to-blue-500' },
        ...
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6">
            ...
            >
              ...
              <span>Ø³ÙŠØ§Ø³Ø© Ø§Ù„Ø®ØµÙˆØµÙŠØ© (Privacy Policy)</span>
            </button>
            <button
            ...
            >
              ...
              <span>Ø´Ø±ÙˆØ· Ø§Ù„Ø®Ø¯Ù…Ø© (Terms)</span>
            </button>
            <button
            ...
            >
              ...
              <span>Ø¹Ù† Ø§Ù„Ù…Ù†ØµØ© ÙˆØ§Ù„Ø£Ø±Ø¨Ø§Ø­ (Monetization)</span>
            </button>
          </div>

          <div className="w-full max-w-4xl my-4">
            <AdContainer format="horizontal" label="Ø¥Ø¹Ù„Ø§Ù† Ø§Ù„Ø±Ø¹Ø§Ø© / Sponsor" />
          </div>

          <div className="pt-8 border-t border-purple-500/20 w-full text-center">
            <p className="text-sm text-[#64748b]">
              Universal Local AI Bridge â€” Powered by Client-Side File System Access API
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#0a0a0f] relative">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-5xl mx-auto px-4 my-8">
          <AdContainer format="horizontal" label="Ù…Ø³Ø§Ø­Ø© Ø¥Ø¹Ù„Ø§Ù†Ø§Øª Google AdSense" />
        </div>
        <DownloadSection />
        <HowItWorksSection />
        <AdvantagesSection />
